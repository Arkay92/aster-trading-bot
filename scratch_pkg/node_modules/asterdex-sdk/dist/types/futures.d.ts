import { OrderSide, OrderStatus, TimeInForce, Timestamp, Decimal, RateLimit } from './common';
 ...
 */
export type IncomeType = 'TRANSFER' | 'WELCOME_BONUS' | 'REALIZED_PNL' | 'FUNDING_FEE' | 'COMMISSION' | 'INSURANCE_CLEAR' | 'REFERRAL_KICKBACK' | 'COMMISSION_REBATE' | 'API_REBATE' | 'CONTEST_REWARD' | 'CROSS_COLLATERAL_TRANSFER' | 'OPTIONS_PREMIUM_FEE' | 'OPTIONS_SETTLE_PROFIT' | 'AUTO_EXCHANGE';
/**
 ...
 */
export type FuturesFilterType = 'PRICE_FILTER' | 'LOT_SIZE' | 'MARKET_LOT_SIZE' | 'MAX_NUM_ORDERS' | 'MAX_NUM_ALGO_ORDERS' | 'PERCENT_PRICE' | 'MIN_NOTIONAL';
/**
 ...
 */
export type FuturesFilter = FuturesPriceFilter | FuturesLotSizeFilter | FuturesMarketLotSizeFilter | (BaseFuturesFilter & Record<string, unknown>);
/**
