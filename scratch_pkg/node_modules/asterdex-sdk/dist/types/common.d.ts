 ...
 */
export type OrderType = 'LIMIT' | 'MARKET' | 'STOP' | 'TAKE_PROFIT' | 'STOP_MARKET' | 'TAKE_PROFIT_MARKET' | 'TRAILING_STOP_MARKET';
/**
 ...
 */
export type FilterType = 'PRICE_FILTER' | 'PERCENT_PRICE' | 'LOT_SIZE' | 'MARKET_LOT_SIZE' | 'MAX_NUM_ORDERS' | 'MIN_NOTIONAL' | 'MAX_NOTIONAL' | 'NOTIONAL' | 'PERCENT_PRICE_BY_SIDE';
/**
 ...
 */
export type Filter = PriceFilter | LotSizeFilter | MarketLotSizeFilter | (BaseFilter & Record<string, unknown>);
/**
